...
//             ui->wdg_jpg , SLOT(slot_setImage(QImage)) );
   ...
   // m_recTimer->start( 500 );
    ...
    ui->cb_food->setText("美食");
    ui->cb_funny->setText("新闻");
    ui->cb_ennegy->setText("科普");
    ui->cb_dance->setText("搞笑");
    ui->cb_music->setText("宠物");
    ui->cb_video->setText("旅游");
    ui->cb_outside->setText("音乐");
    ui->cb_edu->setText("电影");
    //setText();
}
    ...
    while(1)
    {
        ...
        if (packet->stream_index == videoStream) {
                    ...
                    AV_PICTURE_TYPE_I)
            {
                ...
                QImage image = tmpImg.scaled( 621 , 291,
                                              Qt::KeepAspectRatio );
