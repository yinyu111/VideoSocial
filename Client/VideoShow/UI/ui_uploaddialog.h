...
"color: rgb(255, 255, 255);"));
        ...
        sw_page->setGeometry(QRect(10, 40, 791, 541));
        page_1 = new QWidget();
    ...
    void retranslateUi(QDialog *UploadDialog)
    {
        ...
        lb_jpg->setText(QApplication::translate("UploadDialog", "\347\274\251\347\225\245\345\233\276", 0));
