...
QT_MOC_LITERAL(35, 436, 22), // "on_pb_rtmpPlay_clicked"
QT_MOC_LITERAL(36, 459, 27) // "on_pb_uploadHistory_clicked"
    ...
    "on_pb_video_clicked\0on_pb_fresh_clicked\0"
    "on_pb_rtmpPlay_clicked\0"
    "on_pb_uploadHistory_clicked"
};
#undef QT_MOC_LITERAL
...
static const uint qt_meta_data_OnlineDialog[] = {
 ...
 // slots: name, argc, parameters, tag, flags
      ...
      16,    2,  154,    2, 0x0a /* Public */,
      20,    2,  159,    2, 0x0a /* Public */,
      21,    2,  164,    2, 0x0a /* Public */,
      ...
      29,    2,  199,    2, 0x2a /* Public | MethodCloned */,
...
void OnlineDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 21: _t->on_pb_rtmpPlay_clicked(); break;
        case 22: _t->on_pb_uploadHistory_clicked(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OnlineDialog::SIG_PlayTV)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OnlineDialog::SIG_updateProcess)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OnlineDialog::SIG_PlayUrl)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject OnlineDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_OnlineDialog.data,
      qt_meta_data_OnlineDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OnlineDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OnlineDialog.stringdata0))
        return static_cast<void*>(const_cast< OnlineDialog*>(this));
